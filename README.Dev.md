...
`ims-kiwi-ng-opensuse-x86_64-builder' image. It will automatically download the recipe artifact and
use kiwi-ng to build the image as specified in the recipe.
...
Ansible playbooks. These pods use the 'ims-utils' and 'ims-sshd' images.
