...
from ims.helper import validate_artifact, delete_artifact, read_manifest_json, get_log_id
from ims.v2.models.images import V2ImageRecordInputSchema, V2ImageRecordSchema, V2ImageRecordPatchSchema
...
class V2ImageResource(V2BaseImageResource):
    ...
    def patch(self, image_id):
        """ Update an existing imaage record """
        log_id = get_log_id()
