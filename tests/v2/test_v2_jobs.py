...
from ims.v2.models.jobs import STATUS_TYPES
...
@mock.patch("ims.v2.resources.jobs.client")
@mock.patch("ims.v2.resources.jobs.config")
@mock.patch("ims.v2.resources.jobs.utils")
...
class TestV2JobsCollectionEndpoint(TestCase):
    ...
    @mock.patch("ims.v2.resources.jobs.open", new_callable=mock.mock_open, read_data='{"metadata":{"name":"foo"}}')
    @mock.patch("ims.app.app.s3.generate_presigned_url")
    ...
    def test_post_enable_debug_true(self, s3_mock, mock_open, utils_mock, config_mock, client_mock):
        ...
        self.assertItemsEqual(response_data.keys(),
                              ['created', 'job_type', 'artifact_id', 'build_env_size', 'id', 'enable_debug',
                               'public_key_id',
                               'kubernetes_job', 'kubernetes_service', 'kubernetes_configmap', 'ssh_containers',
                               'status',
                               'image_root_archive_name', 'initrd_file_name', 'kernel_file_name', 'resultant_image_id',
                               'kubernetes_namespace'], 'returned keys not the same')
    ...
    @mock.patch("ims.v2.resources.jobs.open", new_callable=mock.mock_open, read_data='{"metadata":{"name":"foo"}}')
    @mock.patch("ims.app.app.s3.generate_presigned_url")
    def test_post_400_create_artifact_not_in_s3(self, s3_mock, mock_open, utils_mock, config_mock, client_mock):
    ...
    @mock.patch("ims.v2.resources.jobs.open", new_callable=mock.mock_open, read_data='{"metadata":{"name":"foo"}}')
    def test_post_400_customize_manifest_not_in_s3(self, mock_open, utils_mock, config_mock, client_mock):
    ...
    @mock.patch("ims.v2.resources.jobs.open", new_callable=mock.mock_open, read_data='{"metadata":{"name":"foo"}}')
    def test_post_400_customize_rootfs_not_in_s3(self, mock_open, utils_mock, config_mock, client_mock):
